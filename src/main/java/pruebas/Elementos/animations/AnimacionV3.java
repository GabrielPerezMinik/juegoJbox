...
public class AnimacionV3  extends AnimationTimer { 
...
//	    private final ImageView imageView; //Image view that will display our sprite
	    ...
	    public AnimacionV3(Image image, int columns, int rows, int totalFrames, int frameWidth, int frameHeight, float framesPerSecond) {
	    ...
	    public Image getCurrentFrame() {
			return frames.get((int) lastFrame);
		} 
